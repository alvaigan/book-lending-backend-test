...
var swagger_1 = __webpack_require__(16);
var constants_1 = __webpack_require__(13);
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, swaggerConfig, swaggerDoc;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    swaggerConfig = new swagger_1.DocumentBuilder()
                        ...
                        .setVersion('v0.0.1')
                        .build();
                    swaggerDoc = swagger_1.SwaggerModule.createDocument(app, swaggerConfig);
                    swagger_1.SwaggerModule.setup('api-doc', app, swaggerDoc);
                    return [4 /*yield*/, app.listen(constants_1.APP_PORT)];
                case 2:
                    _a.sent();
                    if (true) {
                        module.hot.accept();
...
var data_source_1 = __webpack_require__(12);
        ...
        (0, common_1.Module)({
            imports: [
                config_1.ConfigModule.forRoot({
                    isGlobal: true,
                    envFilePath: "".concat(process.cwd(), "/.env.").concat(process.env.NODE_ENV || 'development'),
...
var AppController = /** @class */ (function () {
    ...
    AppController.prototype.getAPIVersion = function () {
    ...
    ], AppController.prototype, "getAPIVersion", null);
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.getAPIVersion = function () {
...
var config_1 = __webpack_require__(7);
var constants_1 = __webpack_require__(13);
var typeorm_1 = __webpack_require__(15);
var config = constants_1.TypeOrmConfig;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.APP_PORT = exports.TypeOrmConfig = void 0;
var dotenv = __webpack_require__(14);
dotenv.config();
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("5c4145cf1aea294a713c")
/******/ 	})();
/******/ 	
